...
/* 가입 안 한 사람에게는 병원 구역부터 아래를 흐리게 덮습니다.
   ...
   ── 2026-09-25 에 달라진 것 ─────────────────────────────────
   전에는 여기가 유일한 자리였고, 흐리기만 하고 자료는 그대로 나갔습니다.
   지금은 **로그인 안 한 분에게는 DB 가 아예 안 내줍니다.** 그래서 이 덮개는
   더 이상 로그인 안 한 분을 만나지 않습니다 — 그쪽은 서버가 가입 권유
   카드(components/members-only.tsx)를 대신 그립니다.

   여기 남은 몫은 **로그인은 했는데 가입 설문을 아직 안 마친 분**입니다.
   그분들에게는 자료가 실제로 실려 오므로 흐림이 흐릴 것이 있습니다.
