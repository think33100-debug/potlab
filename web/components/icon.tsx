...
const PATHS: Record<string, string> = {
  ...
  /* 병원정보 찾기 — 종별 타일 (2026-09-21).
     전부 Lucide 이름입니다. 「재활병원」만 사정이 하나 있습니다 —
     Lucide 의 id-card-lanyard(목걸이에 매달린 세로 신분증)가 우리가 옮겨 적은
     몇 십 개 안에 없어서, 같은 이름으로 여기에 그려 넣었습니다 */
  'layout-grid': 'M3 3h7v7H3zM14 3h7v7h-7zM3 14h7v7H3zM14 14h7v7h-7z',
  hospital: 'M12 6v4M10 8h4M4 22V4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v18M2 22h20M9 22v-4h6v4',
  'id-card-lanyard': 'M9.5 2 12 7l2.5-5M8 7h8a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2ZM10 12h4M10 16h4',
  bed: 'M2 4v16M2 8h18a2 2 0 0 1 2 2v10M2 17h20M6 8v9',
  heart: 'M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z',
  landmark: 'M10 18v-7M14 18v-7M6 18v-7M18 18v-7M3 22h18M2 11h20L12 4Z',
  phone: 'M13.8 13.8a13 13 0 0 1-4.3-4.3l1.4-1.4a1 1 0 0 0 .2-1.1L9.7 3.9a1 1 0 0 0-1.2-.5l-3 1a1 1 0 0 0-.7 1.1A16 16 0 0 0 18.5 19.2a1 1 0 0 0 1.1-.7l1-3a1 1 0 0 0-.5-1.2l-3.1-1.4a1 1 0 0 0-1.1.2Z',
